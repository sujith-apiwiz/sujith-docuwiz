---
title: "Lending Tools via Credit Line"
pageId: "69b3efb1ea357772de95c94a"
---

## Overview

Lending Tools via Credit Line provides specialized infrastructure for managing the credit lifecycle. These tools support the end\-to\-end lending journey — from borrower assessment and origination to monitoring, engagement, and collection — through an integrated API\-first architecture.
...
```text
POST /lending-tools/credit-line
GET  /lending-tools/credit-line/{entityId}
```
