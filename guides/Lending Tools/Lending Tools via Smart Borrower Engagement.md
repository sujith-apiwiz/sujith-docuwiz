---
title: "Lending Tools via Smart Borrower Engagement"
pageId: "69b3efc6ea357772de95c95f"
---

## Overview

Lending Tools via Smart Borrower Engagement provides specialized infrastructure for managing the credit lifecycle. These tools support the end\-to\-end lending journey — from borrower assessment and origination to monitoring, engagement, and collection — through an integrated API\-first architecture.
...
```text
POST /lending-tools/borrower-engagement
GET  /lending-tools/borrower-engagement/{entityId}
```
