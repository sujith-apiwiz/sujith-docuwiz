---
title: "Lending Tools via Loan Origination System"
pageId: "69b3ef7eea357772de95c920"
---

## Overview

Lending Tools via Loan Origination System provides specialized infrastructure for managing the credit lifecycle. These tools support the end\-to\-end lending journey — from borrower assessment and origination to monitoring, engagement, and collection — through an integrated API\-first architecture.
...
```text
POST /lending-tools/loan-origination
GET  /lending-tools/loan-origination/{entityId}
```
