---
title: "Send Funds via Cash Counters"
pageId: "69b3e99eea357772de95c49e"
---

## Overview

Send Funds via Cash Counters is a core disbursement capability that allows enterprises to initiate outbound payments through the banking platform. This channel is designed for businesses that need programmatic, scalable fund movement with full transaction visibility and compliance controls.
...
```text
POST /disbursements/cashcounters
```
