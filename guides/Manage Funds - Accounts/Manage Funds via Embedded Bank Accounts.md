---
title: "Manage Funds via Embedded Bank Accounts"
pageId: "69b3ec6eea357772de95c6fd"
---

## Overview

Manage Funds via Embedded Bank Accounts provides businesses with the ability to programmatically open, configure, and manage bank accounts directly through the banking API. This capability is foundational for fintechs, neobanks, and enterprises that need to automate account lifecycle management at scale.
