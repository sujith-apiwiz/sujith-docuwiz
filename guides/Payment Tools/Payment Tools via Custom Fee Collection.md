---
title: "Payment Tools via Custom Fee Collection"
pageId: "69b3ef5cea357772de95c90b"
---

## Overview

Payment Tools via Custom Fee Collection extends the core payment capabilities of the banking platform with advanced workflow controls, customization features, and intelligent processing logic. These tools are designed for businesses that need fine\-grained control over how payments are orchestrated, validated, and managed at scale.
...
```text
POST /payment-tools/fee-collection/configure
GET  /payment-tools/fee-collection/status
```
