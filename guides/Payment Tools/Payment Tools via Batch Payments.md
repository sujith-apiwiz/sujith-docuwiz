---
title: "Payment Tools via Batch Payments"
pageId: "69b3ee8aea357772de95c861"
---

## Overview

Payment Tools via Batch Payments extends the core payment capabilities of the banking platform with advanced workflow controls, customization features, and intelligent processing logic. These tools are designed for businesses that need fine\-grained control over how payments are orchestrated, validated, and managed at scale.
...
```text
POST /payment-tools/batch/configure
GET  /payment-tools/batch/status
```
