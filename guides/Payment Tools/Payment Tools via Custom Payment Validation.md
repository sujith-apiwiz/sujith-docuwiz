---
title: "Payment Tools via Custom Payment Validation"
pageId: "69b3ef0dea357772de95c8cc"
---

## Overview

Payment Tools via Custom Payment Validation extends the core payment capabilities of the banking platform with advanced workflow controls, customization features, and intelligent processing logic. These tools are designed for businesses that need fine\-grained control over how payments are orchestrated, validated, and managed at scale.
...
```text
POST /payment-tools/validation/configure
GET  /payment-tools/validation/status
```
