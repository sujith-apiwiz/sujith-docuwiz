---
title: "Payment Tools via Smart Fraud & Risk Management"
pageId: "69b3ef42ea357772de95c8f6"
---

## Overview

Payment Tools via Smart Fraud & Risk Management extends the core payment capabilities of the banking platform with advanced workflow controls, customization features, and intelligent processing logic. These tools are designed for businesses that need fine\-grained control over how payments are orchestrated, validated, and managed at scale.
...
```text
POST /payment-tools/fraud-risk/configure
GET  /payment-tools/fraud-risk/status
```
