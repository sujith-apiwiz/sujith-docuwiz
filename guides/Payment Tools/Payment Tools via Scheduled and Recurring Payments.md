---
title: "Payment Tools via Scheduled and Recurring Payments"
pageId: "69b3eeb1ea357772de95c878"
---

## Overview

Payment Tools via Scheduled and Recurring Payments extends the core payment capabilities of the banking platform with advanced workflow controls, customization features, and intelligent processing logic. These tools are designed for businesses that need fine\-grained control over how payments are orchestrated, validated, and managed at scale.
...
```text
POST /payment-tools/scheduled/configure
GET  /payment-tools/scheduled/status
```
