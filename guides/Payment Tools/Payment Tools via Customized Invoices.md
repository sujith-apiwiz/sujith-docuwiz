---
title: "Payment Tools via Customized Invoices"
pageId: "69b3eefaea357772de95c8b7"
---

## Overview

Payment Tools via Customized Invoices extends the core payment capabilities of the banking platform with advanced workflow controls, customization features, and intelligent processing logic. These tools are designed for businesses that need fine\-grained control over how payments are orchestrated, validated, and managed at scale.
...
```text
POST /payment-tools/invoices/configure
GET  /payment-tools/invoices/status
```
