---
title: "Payment Tools via Custom Payment Confirmation"
pageId: "69b3ef27ea357772de95c8e1"
---

## Overview

Payment Tools via Custom Payment Confirmation extends the core payment capabilities of the banking platform with advanced workflow controls, customization features, and intelligent processing logic. These tools are designed for businesses that need fine\-grained control over how payments are orchestrated, validated, and managed at scale.
...
```text
POST /payment-tools/confirmation/configure
GET  /payment-tools/confirmation/status
```
