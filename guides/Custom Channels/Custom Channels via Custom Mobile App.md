---
title: "Custom Channels via Custom Mobile App"
pageId: "69b3f010ea357772de95c9a0"
---

## Overview

Custom Channels via Custom Mobile App enables businesses to deliver banking services and customer experiences through fully customized digital touchpoints. Rather than relying on standard bank interfaces, businesses can embed, extend, or entirely build their own channels powered by the banking platform's core APIs.
...
```text
Custom Channel (Custom Channels via Custom Mobile App)
        ↓ OAuth2 Token
Banking API Gateway
        ↓
...
```text
POST /channels/custom-mobile-app/register
GET  /channels/custom-mobile-app/{channelId}/status
```
