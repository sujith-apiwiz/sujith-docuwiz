---
title: "Custom Channels via Custom Webpage"
pageId: "69b3eff8ea357772de95c98b"
---

## Overview

Custom Channels via Custom Webpage enables businesses to deliver banking services and customer experiences through fully customized digital touchpoints. Rather than relying on standard bank interfaces, businesses can embed, extend, or entirely build their own channels powered by the banking platform's core APIs.
...
```text
Custom Channel (Custom Channels via Custom Webpage)
        ↓ OAuth2 Token
Banking API Gateway
        ↓
...
```text
POST /channels/custom-webpage/register
GET  /channels/custom-webpage/{channelId}/status
```
