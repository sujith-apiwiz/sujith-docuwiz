---
title: "Custom Channels via SDK"
pageId: "69b3efe5ea357772de95c976"
---

## Overview

Custom Channels via SDK enables businesses to deliver banking services and customer experiences through fully customized digital touchpoints. Rather than relying on standard bank interfaces, businesses can embed, extend, or entirely build their own channels powered by the banking platform's core APIs.
...
```text
Custom Channel (Custom Channels via SDK)
        ↓ OAuth2 Token
Banking API Gateway
        ↓
...
```text
POST /channels/sdk/register
GET  /channels/sdk/{channelId}/status
```
