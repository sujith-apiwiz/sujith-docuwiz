---
title: "Reports via SFTP"
pageId: "69b3ee4bea357772de95c837"
---

## Overview

Reports via SFTP provides structured access to banking transaction data, account activity, and financial summaries. Comprehensive reporting is essential for reconciliation, regulatory compliance, financial planning, and audit readiness.
...
```text
POST /reports/sftp/generate
GET  /reports/sftp/{reportId}/status
GET  /reports/sftp/{reportId}/download
```
