---
title: "Reports via Self-Service Dashboard"
pageId: "69b3ee17ea357772de95c80d"
---

## Overview

Reports via Self\-Service Dashboard provides structured access to banking transaction data, account activity, and financial summaries. Comprehensive reporting is essential for reconciliation, regulatory compliance, financial planning, and audit readiness.
...
```text
POST /reports/self-service/generate
GET  /reports/self-service/{reportId}/status
GET  /reports/self-service/{reportId}/download
```
