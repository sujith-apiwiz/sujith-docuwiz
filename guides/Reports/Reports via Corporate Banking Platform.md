---
title: "Reports via Corporate Banking Platform"
pageId: "69b3edfdea357772de95c7f8"
---

## Overview

Reports via Corporate Banking Platform provides structured access to banking transaction data, account activity, and financial summaries. Comprehensive reporting is essential for reconciliation, regulatory compliance, financial planning, and audit readiness.
...
```text
POST /reports/corporate-banking/generate
GET  /reports/corporate-banking/{reportId}/status
GET  /reports/corporate-banking/{reportId}/download
```
